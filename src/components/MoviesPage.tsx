    ...
    const fetchMovies = async () => {
      ...
      try {
        ...
        if (selectedGenre === 'all') {
          ...
          url = `https://api.themoviedb.org/3/movie/popular?api_key=ddb1bdf6aa91bdf335797853884b0c1d&language=pt-BR&page=1`;
        } else {
          // Buscar filmes por gênero
          url = `https://api.themoviedb.org/3/discover/movie?api_key=ddb1bdf6aa91bdf335797853884b0c1d&language=pt-BR&with_genres=${selectedGenre}&sort_by=popularity.desc&page=1`;
        }
        ...
        if (data.results) {
          ...
          const movieWithBackdrop = moviesWithType.find((m: Movie) => m.backdrop_path);
          setFeaturedMovie(movieWithBackdrop || moviesWithType[0] || null);
        }
      } catch (error) {
